...
public class LowestPEExecutor implements StockDataExecutor {
	final static Logger logger = Logger.getLogger(LowestPEExecutor.class);
	...
	public LowestPEExecutor(MessageSender messageSender) {
	...
	public void executeCheck(Stock stock) throws IOException {
		...
		if(pe!=null)
		changeMap.put(stock.getSymbol(), pe.doubleValue());
	}
